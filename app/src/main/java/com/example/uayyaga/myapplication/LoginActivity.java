...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //giving action for login button
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            admin.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent newUserIntent = new Intent(LoginActivity.this,AdminPageActivity.class);
                    startActivity(newUserIntent);
                }
            });

            //giving action for new user registration
            newUser.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent newUserIntent = new Intent(LoginActivity.this,NewUserRegistration.class);
                    startActivity(newUserIntent);
                }
            });
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            if(pwd.equals(storedPassword))
            {
                ...
                //creating intent to send the email ID from first activity to the next
                Intent i = new Intent(this, UsernameActivity.class);

                i.putExtra("KEY",mEmailView.getText().toString());
                startActivity(i);
                finish();
            }
            else
